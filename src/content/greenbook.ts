...
const greenbookContentZh = {
  ...
  chapters: [
    ...
    },
    {
      ...
      defaultOpen: false,
      paragraphs: [
        "WAN 是 72H 的真实使用场景之一。它以网页入口为主，移动端保留网络连接服务和 72H 充值等关键能力。",
...
const greenbookContentEn = {
  ...
  chapters: [
    ...
    },
    {
      ...
      defaultOpen: false,
      paragraphs: [
        "WAN is one of the real usage entries for 72H. It is a web-first service entry, while native clients keep network access service and 72H recharge as key capabilities.",
