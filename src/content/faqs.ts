...
const faqItemsZh: FAQItem[] = [
  ...
  },
  {
    ...
    category: "安全",
    question: "怎么确认官方入口？",
    answer: "加入或使用任何外部入口前，请先通过本站、绿皮书和站内链接核验是否为官方入口。",
...
const faqItemsEn: FAQItem[] = [
  ...
  },
  {
    ...
    answer: "Before joining or using any external entry point, verify it through this website, Green Book, and links shown on this site.",
