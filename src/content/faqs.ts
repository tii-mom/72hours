...
const faqItemsZh: FAQItem[] = [
  ...
  },
  {
    ...
    category: "学习",
    question: "学习和参与是什么关系？",
    answer: "线上报名、线下报名，对应不同学习安排。",
    relatedLinks: [{ label: "学习报名", href: "/learn" }],
    priority: 3,
    isPinned: true,
  },
  {
...
const faqItemsEn: FAQItem[] = [
  ...
  },
  {
    ...
    answer: "Online and offline applications lead to different learning arrangements.",
    relatedLinks: [{ label: "Learning application", href: "/learn" }],
    priority: 3,
    isPinned: true,
  },
  {
